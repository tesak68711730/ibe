...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static final String AUTHORIZED_ROLE2 = "authorizedRoleName2";
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers(HttpMethod.GET, "/transactions/list").hasRole(AUTHORIZED_ROLE2) // maybe has role
                .antMatchers(HttpMethod.GET, "/categories/list").hasRole(AUTHORIZED_ROLE2)
//                .antMatchers(HttpMethod.OPTIONS, "/categories/list").permitAll()
